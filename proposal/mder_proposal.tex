...
%
%  IMPORTANT: this is a COMPLETE document. Do not paste it into an existing
%  Overleaf project that already has \documentclass ... \begin{document}.
%  Doing so produces two preambles, and LaTeX fails with
%      "\documentclass can be used only in preamble"
%  because every \usepackage then sits after \begin{document}.
%
%  Correct usage: replace the whole of main.tex with this file, or upload it
%  as its own .tex and set it as the compile target.
%
%      pdflatex mder_proposal.tex     (run twice)
%
%  Edit \orgname below before circulating.
%==============================================================================
...
\newcommand{\authorname}{Jacob Nicholas Douglas Bethell}
...
\begin{center}
  ...
  {\small\color{black!55} Prepared for \orgname\ --- August 2026}
\end{center}
